 ...
 * * Copyright * 圣通电力
 *
 * @ProjectName: Webrtc-Android-Demo
 * @Package: com.dds.webrtclib.ui
 * @ClassName: ChatSingleScreenActivity
 * @Description: 屏幕共享界面
 * @Author: Raphrodite
 * @CreateDate: 2023/2/6
 */
public class ChatSingleScreenActivity extends AppCompatActivity {
    ...
    public static void openActivity(Activity activity, boolean videoEnable) {
        Intent intent = new Intent(activity, ChatSingleScreenActivity.class);
    ...
    private void initVar() {
        ...
        ChatSingleScreenFragment chatSingleScreenFragment = new ChatSingleScreenFragment();
        replaceFragment(chatSingleScreenFragment, videoEnable);
...
//            Log.e("zrzr", "deviceName = " + deviceName);
//            if(!"Xiaomi".equals(deviceName)) {
    ...
    private void startCall() {
        ...
        manager.setCallback(new IViewCallback() {
            ...
            public void onCloseWithId(String socketId) {
                runOnUiThread(() -> {
                    disConnect();
                    ChatSingleScreenActivity.this.finish();
                });

            }
        });
        if (!PermissionUtil.isNeedRequestPermission(ChatSingleScreenActivity.this)) {
...
//            videoCapturer.startCapture(480, 640, 30);
            ...
            manager.joinRoom(getApplicationContext(), rootEglBase, captureIntent);
